REACT.JS ou (single page application) são aplicações webem que todas as aplicaçõs entao em uma página. A senssação de que o usuário está em várias páginas.
